...
function Diseases() {
  ...
  const deleteDisease = async (diseaseId) => {
    ...
    try {
      console.log('Sending DELETE request to:', `${import.meta.env.VITE_API_BASE_URL}/delete_disease.php`);
      const response = await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/delete_disease.php`, {
        data: { id: diseaseId }
      });
